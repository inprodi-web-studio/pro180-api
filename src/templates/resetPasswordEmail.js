                            ...
                            <tbody>
                              <tr style="">
                                <td class="center-text" align="center"
                                  ...
                                  <div style="margin: 0px; padding: 0px;">
                                    <p style="margin: 0px; padding: 0px;">RESTABLECE TU CONTRASEÑA</p>
                                  </div>
                              ...
                              <tr>
                                <td class="center-text" align="center"
                                  ...
                                  <div style="margin: 0px; padding: 0px;">
                                    <p style="margin: 0px; padding: 0px;">¡Hola!</p>
                                  </div>
                              ...
                              <tr style="">
                                <td class="center-text" align="center"
                                  ...
                                  <div style="margin: 0px; padding: 0px;">
                                    <p style="margin: 0px; padding: 0px;">Hemos recibido una solicitud para restablecer
                                      tu contraseña. No te preocupes, siempre pasa. Solo debes de ingresar tu código de
                                      verificación para poder cambiar tu contraseña nuevamente.</p>
                                  </div>
                              ...
                              <tr>
                                <td class="center-text" align="center"
                                  style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:12px;line-height:22px;font-weight:400;font-style:normal;color:rgb(20, 24, 27);text-decoration:none;letter-spacing:0px;text-align:center;padding-top: 40px;">

                                  <div style="margin: 0px; padding: 0px;">
                                    <p style="margin: 0px; padding: 0px;">En caso de que tu no hayas solicitado
                                      restablecer la contraseña de tu cuenta, puedes ignorar este correo.</p>
                                  </div>
